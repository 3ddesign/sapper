...
var store_mjs = require('svelte/store.mjs');
...
<p class="${"svelte-8od9u6"}">An error occurred!</p>
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/about\/?$/,
			parts: [
				{ name: "about", file: "about/index.svelte", component: About }
			]
		},
		...
		try {
			...
			const props = {
				stores: {
					...
					preloading: {
						subscribe: store_mjs.writable(null).subscribe
					},
					session: store_mjs.writable(session)
				},
